...
// The for loop will check each natural number between 1 and the max_value 
// to see if it is a multiple of 3 or 5.
for (counter = 1; counter < max_value; counter += 1) {
    ...
    if ((counter % first_multiple === 0) || (counter % second_multiple === 0)) {
        // If we have found a multiple of either first_multiple or second_multiple 
        // then we add it to our sum.
        sum += counter;
    }
}
